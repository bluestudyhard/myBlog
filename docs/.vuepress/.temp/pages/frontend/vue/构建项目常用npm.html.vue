<template><div><h2 id="vite-启动模板-fork-antfu" tabindex="-1"><a class="header-anchor" href="#vite-启动模板-fork-antfu" aria-hidden="true">#</a> vite 启动模板 fork antfu</h2>
<p><a href="https://github.com/bluestudyhard/vite-template" target="_blank" rel="noopener noreferrer">https://github.com/bluestudyhard/vite-template<ExternalLinkIcon/></a></p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/bluestudyhard/vite-template.git
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="新建-vite-项目" tabindex="-1"><a class="header-anchor" href="#新建-vite-项目" aria-hidden="true">#</a> 新建 vite 项目</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">pnpm</span> create vite@latest
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="新建-vue-项目" tabindex="-1"><a class="header-anchor" href="#新建-vue-项目" aria-hidden="true">#</a> 新建 vue 项目</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">pnpm</span> init vue@latest
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="安装-element-plus" tabindex="-1"><a class="header-anchor" href="#安装-element-plus" aria-hidden="true">#</a> 安装 element plus</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">pnpm</span> <span class="token function">install</span> element-plus <span class="token parameter variable">--save</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="安装-vue-router" tabindex="-1"><a class="header-anchor" href="#安装-vue-router" aria-hidden="true">#</a> 安装 vue-router</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">pnpm</span> <span class="token function">install</span> vue-router@4
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="自动注册路由" tabindex="-1"><a class="header-anchor" href="#自动注册路由" aria-hidden="true">#</a> 自动注册路由</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">import</span> <span class="token punctuation">{</span> createRouter, createWebHashHistory, RouteRecordRaw <span class="token punctuation">}</span> from <span class="token string">'vue-router'</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="文件式路由" tabindex="-1"><a class="header-anchor" href="#文件式路由" aria-hidden="true">#</a> 文件式路由</h3>
<h2 id="pinia" tabindex="-1"><a class="header-anchor" href="#pinia" aria-hidden="true">#</a> pinia</h2>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">pnpm</span> <span class="token function">install</span> pinia
<span class="token function">pnpm</span> <span class="token function">install</span> pinia-plugin-persistedstate
<span class="token comment"># 在main.ts中</span>
...
<span class="token function">import</span> piniaPluginPersistedstate from <span class="token string">'pinia-plugin-persistedstate'</span>
...
app.use<span class="token punctuation">(</span>pinia<span class="token punctuation">)</span>
pinia.use<span class="token punctuation">(</span>piniaPluginPersistedstate<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="nodejs" tabindex="-1"><a class="header-anchor" href="#nodejs" aria-hidden="true">#</a> nodejs</h2>
<h3 id="express" tabindex="-1"><a class="header-anchor" href="#express" aria-hidden="true">#</a> express</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>express: <span class="token function">pnpm</span> <span class="token function">install</span> express
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="antfu-eslintconfig" tabindex="-1"><a class="header-anchor" href="#antfu-eslintconfig" aria-hidden="true">#</a> antfu eslintconfig</h2>
<ul>
<li>Single quotes, no semi<br>
单引号，无半引号</li>
<li>Auto fix for formatting (aimed to be used standalone <strong>without</strong> Prettier)<br>
自动修复格式（旨在独立使用，无需 Prettier）</li>
<li>Designed to work with TypeScript, Vue out-of-box<br>
专为与 TypeScript、Vue 一起使用而设计，开箱即用</li>
<li>Lint also for json, yaml, markdown<br>
Lint 也适用于 json、yaml、markdown</li>
<li>Sorted imports, dangling commas<br>
已排序的导入，悬空逗号</li>
<li>Reasonable defaults, best practices, only one-line of config<br>
合理的默认值，最佳实践，只需一行配置</li>
<li><strong>Style principle</strong>: Minimal for reading, stable for diff<br>
风格原则：阅读最小化，差异稳定</li>
</ul>
<h2 id="usage-用法" tabindex="-1"><a class="header-anchor" href="#usage-用法" aria-hidden="true">#</a> <a href="https://github.com/antfu/eslint-config#usage" target="_blank" rel="noopener noreferrer"><ExternalLinkIcon/></a>Usage  用法</h2>
<h3 id="install-安装" tabindex="-1"><a class="header-anchor" href="#install-安装" aria-hidden="true">#</a> <a href="https://github.com/antfu/eslint-config#install" target="_blank" rel="noopener noreferrer"><ExternalLinkIcon/></a>Install  安装</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">pnpm</span> <span class="token function">add</span> <span class="token parameter variable">-D</span> eslint @antfu/eslint-config
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="config-eslintrc-配置-eslintrc" tabindex="-1"><a class="header-anchor" href="#config-eslintrc-配置-eslintrc" aria-hidden="true">#</a> <a href="https://github.com/antfu/eslint-config#config-eslintrc" target="_blank" rel="noopener noreferrer"><ExternalLinkIcon/></a>Config <code v-pre>.eslintrc</code>  配置  <code v-pre>.eslintrc</code></h3>
...
<p>You don't need <code v-pre>.eslintignore</code> normally as it has been provided by the preset.<br>
通常您不需要  <code v-pre>.eslintignore</code> ，因为它已由预设提供。</p>
</blockquote>
<h3 id="add-script-for-package-json" tabindex="-1"><a class="header-anchor" href="#add-script-for-package-json" aria-hidden="true">#</a> <a href="https://github.com/antfu/eslint-config#add-script-for-packagejson" target="_blank" rel="noopener noreferrer"><ExternalLinkIcon/></a>Add script for package.json</h3>
<p>为 package.json 添加脚本</p>
<p>For example:  例如：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vs-code-support-auto-fix" tabindex="-1"><a class="header-anchor" href="#vs-code-support-auto-fix" aria-hidden="true">#</a> <a href="https://github.com/antfu/eslint-config#vs-code-support-auto-fix" target="_blank" rel="noopener noreferrer"><ExternalLinkIcon/></a>VS Code support (auto fix)</h3>
<p>VS Code 支持（自动修复）</p>
<p>Install <a href="https://marketplace.visualstudio.com/items?itemName=dbaeumer.vscode-eslint" target="_blank" rel="noopener noreferrer">VS Code ESLint extension<ExternalLinkIcon/></a><br>
安装 VS Code ESLint 扩展</p>
<p>Add the following settings to your <code v-pre>settings.json</code>:<br>
将以下设置添加到您的  <code v-pre>settings.json</code>  中：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="typescript-aware-rules-typescript-感知规则" tabindex="-1"><a class="header-anchor" href="#typescript-aware-rules-typescript-感知规则" aria-hidden="true">#</a> <a href="https://github.com/antfu/eslint-config#typescript-aware-rules" target="_blank" rel="noopener noreferrer"><ExternalLinkIcon/></a>TypeScript Aware Rules TypeScript 感知规则</h3>
<p>Type aware rules are enabled when a <code v-pre>tsconfig.eslint.json</code> is found in the project root, which will introduce some stricter rules into your project. If you want to enable it while have no <code v-pre>tsconfig.eslint.json</code> in the project root, you can change tsconfig name by modifying <code v-pre>ESLINT_TSCONFIG</code> env.<br>
当在项目根目录中找到  <code v-pre>tsconfig.eslint.json</code>  时，就会启用类型感知规则，这将在您的项目中引入一些更严格的规则。如果您想在项目根目录中没有  <code v-pre>tsconfig.eslint.json</code>  的情况下启用它，可以通过修改  <code v-pre>ESLINT_TSCONFIG</code> env 来更改 tsconfig 名称。</p>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="lint-staged" tabindex="-1"><a class="header-anchor" href="#lint-staged" aria-hidden="true">#</a> <a href="https://github.com/antfu/eslint-config#lint-staged" target="_blank" rel="noopener noreferrer"><ExternalLinkIcon/></a>Lint Staged</h3>
<p>If you want to apply lint and auto-fix before every commit, you can add the following to your <code v-pre>package.json</code>:<br>
如果您想在每次提交之前应用 lint 和自动修复，您可以将以下内容添加到您的  <code v-pre>package.json</code>  中：</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>and then  进而</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">npm</span> i <span class="token parameter variable">-D</span> lint-staged simple-git-hooks
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="badge-徽章" tabindex="-1"><a class="header-anchor" href="#badge-徽章" aria-hidden="true">#</a> <a href="https://github.com/antfu/eslint-config#badge" target="_blank" rel="noopener noreferrer"><ExternalLinkIcon/></a>Badge  徽章</h2>
<p>If you enjoy this code style, and would like to mention it in your project, here is the badge you can use:<br>
如果您喜欢这种代码风格，并且想在您的项目中提及它，那么您可以使用以下徽章：</p>
<div class="language-markdown line-numbers-mode" data-ext="md"><pre v-pre class="language-markdown"><code><span class="token url">[<span class="token content">![code style</span>](<span class="token url">https://antfu.me/badge-code-style.svg</span>)</span>](https://github.com/antfu/eslint-config)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><a href="https://github.com/antfu/eslint-config" target="_blank" rel="noopener noreferrer"><img src="https://camo.githubusercontent.com/3e0d29fd4b1e4dc7afa6af9f7def74425cb43b39dfd8899b5135f46eb135dbb4/68747470733a2f2f616e7466752e6d652f62616467652d636f64652d7374796c652e737667" alt="code style" tabindex="0" loading="lazy"><ExternalLinkIcon/></a><figcaption>code style</figcaption></figure>
<h2 id="faq-常问问题" tabindex="-1"><a class="header-anchor" href="#faq-常问问题" aria-hidden="true">#</a> <a href="https://github.com/antfu/eslint-config#faq" target="_blank" rel="noopener noreferrer"><ExternalLinkIcon/></a>FAQ  常问问题</h2>
<h3 id="prettier-更漂亮" tabindex="-1"><a class="header-anchor" href="#prettier-更漂亮" aria-hidden="true">#</a> <a href="https://github.com/antfu/eslint-config#prettier" target="_blank" rel="noopener noreferrer"><ExternalLinkIcon/></a>Prettier?  更漂亮？</h3>
<p><a href="https://antfu.me/posts/why-not-prettier" target="_blank" rel="noopener noreferrer">Why I don't use Prettier<br>
为什么我不使用 Prettier<ExternalLinkIcon/></a></p>
<h3 id="how-to-lint-css" tabindex="-1"><a class="header-anchor" href="#how-to-lint-css" aria-hidden="true">#</a> <a href="https://github.com/antfu/eslint-config#how-to-lint-css" target="_blank" rel="noopener noreferrer"><ExternalLinkIcon/></a>How to lint CSS?</h3>
<p>如何对 CSS 进行 lint 处理？</p>
<p>This config does NOT lint CSS. I personally use <a href="https://github.com/unocss/unocss" target="_blank" rel="noopener noreferrer">UnoCSS<ExternalLinkIcon/></a> so I don't write CSS. If you still prefer CSS, you can use <a href="https://stylelint.io/" target="_blank" rel="noopener noreferrer">stylelint<ExternalLinkIcon/></a> for CSS linting.<br>
此配置不会 lint CSS。我个人使用 UnoCSS 所以我不写 CSS。如果您仍然喜欢 CSS，可以使用 stylelint 进行 CSS linting。</p>
<h3 id="i-prefer-xxx-我更喜欢-xxx" tabindex="-1"><a class="header-anchor" href="#i-prefer-xxx-我更喜欢-xxx" aria-hidden="true">#</a> <a href="https://github.com/antfu/eslint-config#i-prefer-xxx" target="_blank" rel="noopener noreferrer"><ExternalLinkIcon/></a>I prefer XXX...  我更喜欢 XXX...</h3>
<p>Sure, you can override the rules in your <code v-pre>.eslintrc</code> file.<br>
当然，您可以覆盖  <code v-pre>.eslintrc</code>  文件中的规则。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Or you can always fork this repo and make your own.<br>
或者您可以随时分叉此存储库并创建您自己的存储库。</p>
<h2 id="check-also-另请检查" tabindex="-1"><a class="header-anchor" href="#check-also-另请检查" aria-hidden="true">#</a> <a href="https://github.com/antfu/eslint-config#check-also" target="_blank" rel="noopener noreferrer"><ExternalLinkIcon/></a>Check Also  另请检查</h2>
<ul>
<li><a href="https://github.com/antfu/dotfiles" target="_blank" rel="noopener noreferrer">antfu/dotfiles<ExternalLinkIcon/></a> - My dotfiles<br>
antfu/dotfiles - 我的点文件</li>
<li><a href="https://github.com/antfu/vscode-settings" target="_blank" rel="noopener noreferrer">antfu/vscode-settings<ExternalLinkIcon/></a> - My VS Code settings<br>
antfu/vscode-settings - 我的 VS Code 设置</li>
<li><a href="https://github.com/antfu/ts-starter" target="_blank" rel="noopener noreferrer">antfu/ts-starter<ExternalLinkIcon/></a> - My starter template for TypeScript library<br>
antfu/ts-starter - 我的 TypeScript 库入门模板</li>
<li><a href="https://github.com/antfu/vitesse" target="_blank" rel="noopener noreferrer">antfu/vitesse<ExternalLinkIcon/></a> - My starter template for Vue &amp; Vite app<br>
antfu/vitesse - 我的 Vue 和 Vite 应用程序的入门模板</li>
</ul>
<h2 id="reset-scss" tabindex="-1"><a class="header-anchor" href="#reset-scss" aria-hidden="true">#</a> reset.scss</h2>
